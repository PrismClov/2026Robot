...
void Class_Omni_Chassis::Init(float __Velocity_X_Max, float __Velocity_Y_Max, float __Omega_Max)
{
    ...
    //轮向电机ID初始化
    Motor_Wheel[0].Init(&hcan1, Motor_DJI_ID_0x201);
    Motor_Wheel[1].Init(&hcan1, Motor_DJI_ID_0x202);
    Motor_Wheel[2].Init(&hcan1, Motor_DJI_ID_0x203);
    Motor_Wheel[3].Init(&hcan1, Motor_DJI_ID_0x204);
