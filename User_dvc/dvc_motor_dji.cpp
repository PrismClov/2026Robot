 ...
 */
uint8_t *allocate_tx_data(FDCAN_HandleTypeDef *hfdcan, Enum_Motor_DJI_ID __FDCAN_ID, Enum_Motor_DJI_GM6020_Driver_Version __DJI_Motor_Driver_Version = Motor_DJI_GM6020_Driver_Version_DEFAULT)
{
    ...
    else if (hfdcan == &hfdcan3)
    {
        ...
        case (Motor_DJI_ID_0x201):
        {
            tmp_tx_data_ptr = &(FDCAN3_0x200_Tx_Data[0]);

            break;
        }
        case (Motor_DJI_ID_0x202):
        {
            tmp_tx_data_ptr = &(FDCAN3_0x200_Tx_Data[2]);

            break;
        }
        case (Motor_DJI_ID_0x203):
        {
            tmp_tx_data_ptr = &(FDCAN3_0x200_Tx_Data[4]);

            break;
        }
        case (Motor_DJI_ID_0x204):
        {
            tmp_tx_data_ptr = &(FDCAN3_0x200_Tx_Data[6]);
        ...
        case (Motor_DJI_ID_0x205):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1ff_Tx_Data[0]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1fe_Tx_Data[0]);
            }
        ...
        case (Motor_DJI_ID_0x206):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1ff_Tx_Data[2]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1fe_Tx_Data[2]);
            }
        ...
        case (Motor_DJI_ID_0x207):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1ff_Tx_Data[4]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1fe_Tx_Data[4]);
            }
        ...
        case (Motor_DJI_ID_0x208):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1ff_Tx_Data[6]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x1fe_Tx_Data[6]);
            }
        ...
        case (Motor_DJI_ID_0x209):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x2ff_Tx_Data[0]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x2fe_Tx_Data[0]);
            }
        ...
        case (Motor_DJI_ID_0x20A):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x2ff_Tx_Data[2]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x2fe_Tx_Data[2]);
            }
        ...
        case (Motor_DJI_ID_0x20B):
        {
            if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_DEFAULT)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x2ff_Tx_Data[4]);
            }
            else if (__DJI_Motor_Driver_Version == Motor_DJI_GM6020_Driver_Version_2023)
            {
                tmp_tx_data_ptr = &(FDCAN3_0x2fe_Tx_Data[4]);
            }
 ...
 */
void Class_Motor_DJI_GM6020::Init(FDCAN_HandleTypeDef *hfdcan, Enum_Motor_DJI_ID __FDCAN_Rx_ID, Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method, int32_t __Encoder_Offset, Enum_Motor_DJI_GM6020_Driver_Version __Driver_Version, Enum_Motor_DJI_Power_Limit_Status __Power_Limit_Status, float __Voltage_Max, float __Current_Max)
{
    //绑定对应结构体至电机CAN结构体
    ...
    //将分配的地址空间指针传入
    Tx_Data = allocate_tx_data(hfdcan, __FDCAN_Rx_ID, __Driver_Version);
}
 ...
 * @param __Current_Max 最大电流
 */
void Class_Motor_DJI_C610::Init(FDCAN_HandleTypeDef *hfdcan, Enum_Motor_DJI_ID __FDCAN_Rx_ID, Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method, float __Gearbox_Rate, float __Current_Max)
{
    if (hfdcan->Instance == FDCAN1)
    {
        FDCAN_Manage_Object = &FDCAN1_Manage_Object;
    ...
    Current_Max = __Current_Max;
    Tx_Data = allocate_tx_data(hfdcan, __FDCAN_Rx_ID);
}
 ...
 * @param __Current_Max 最大电流
 */
void Class_Motor_DJI_C620::Init(FDCAN_HandleTypeDef *hfdcan, Enum_Motor_DJI_ID __FDCAN_Rx_ID, Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method, float __Gearbox_Rate, Enum_Motor_DJI_Power_Limit_Status __Power_Limit_Status, float __Current_Max)
{
    if (hfdcan->Instance == FDCAN1)
    {
        FDCAN_Manage_Object = &FDCAN1_Manage_Object;
