...
uint8_t *allocate_tx_data(FDCAN_HandleTypeDef *hcan, Enum_Motor_DM_Motor_ID_1_To_4 __CAN_Rx_ID_1_To_4)
{
    ...
    if (hcan == &hfdcan1)
    {
        ...
        {
            tmp_tx_data_ptr = &(FDCAN1_0x3fe_Tx_Data[0]);

            break;
        }
        case (Motor_DM_ID_0x302):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x3fe_Tx_Data[2]);

            break;
        }
        case (Motor_DM_ID_0x303):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x3fe_Tx_Data[4]);

            break;
        }
        case (Motor_DM_ID_0x304):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x3fe_Tx_Data[6]);

            break;
        }
        case (Motor_DM_ID_0x305):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x4fe_Tx_Data[0]);

            break;
        }
        case (Motor_DM_ID_0x306):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x4fe_Tx_Data[2]);

            break;
        }
        case (Motor_DM_ID_0x307):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x4fe_Tx_Data[4]);

            break;
        }
        case (Motor_DM_ID_0x308):
        {
            tmp_tx_data_ptr = &(FDCAN1_0x4fe_Tx_Data[6]);
    ...
    else if (hcan == &hfdcan2)
    {
        ...
        case (Motor_DM_ID_0x301):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x3fe_Tx_Data[0]);

            break;
        }
        case (Motor_DM_ID_0x302):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x3fe_Tx_Data[2]);

            break;
        }
        case (Motor_DM_ID_0x303):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x3fe_Tx_Data[4]);

            break;
        }
        case (Motor_DM_ID_0x304):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x3fe_Tx_Data[6]);

            break;
        }
        case (Motor_DM_ID_0x305):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x4fe_Tx_Data[0]);

            break;
        }
        case (Motor_DM_ID_0x306):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x4fe_Tx_Data[2]);

            break;
        }
        case (Motor_DM_ID_0x307):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x4fe_Tx_Data[4]);

            break;
        }
        case (Motor_DM_ID_0x308):
        {
            tmp_tx_data_ptr = &(FDCAN2_0x4fe_Tx_Data[6]);
 ...
 */
void Class_Motor_DM_Normal::Init(FDCAN_HandleTypeDef *hfdcan, uint8_t __CAN_Rx_ID, uint8_t __CAN_Tx_ID, Enum_Motor_DM_Control_Method __Motor_DM_Control_Method, float __Angle_Max, float __Omega_Max, float __Torque_Max, float __Current_Max)
{
...
void Class_Motor_DM_Normal::CAN_Send_Clear_Error()
{
    ...
    FDCAN_Send_Data(FDCAN_Manage_Object->FDCAN_Handler, CAN_Tx_ID, DM_Motor_CAN_Message_Clear_Error, FDCAN_ID_Standard, 8);
}
...
void Class_Motor_DM_Normal::CAN_Send_Enter()
{
    ...
    FDCAN_Send_Data(FDCAN_Manage_Object->FDCAN_Handler, CAN_Tx_ID, DM_Motor_CAN_Message_Enter, FDCAN_ID_Standard, 8);
}
...
void Class_Motor_DM_Normal::CAN_Send_Exit()
{
    ...
    FDCAN_Send_Data(FDCAN_Manage_Object->FDCAN_Handler, CAN_Tx_ID, DM_Motor_CAN_Message_Exit, FDCAN_ID_Standard, 8);
}
...
void Class_Motor_DM_Normal::CAN_Send_Save_Zero()
{
    ...
    FDCAN_Send_Data(FDCAN_Manage_Object->FDCAN_Handler, CAN_Tx_ID, DM_Motor_CAN_Message_Save_Zero, FDCAN_ID_Standard, 8);
}
...
void Class_Motor_DM_Normal::Output()
{
    ...
    case (Motor_DM_Control_Method_NORMAL_OMEGA):
    {
        ...
        FDCAN_Send_Data(FDCAN_Manage_Object->FDCAN_Handler, CAN_Tx_ID, Tx_Data, FDCAN_ID_Standard, 4);
 ...
 */
void Class_Motor_DM_1_To_4::Init(FDCAN_HandleTypeDef *hfdcan, Enum_Motor_DM_Motor_ID_1_To_4 __CAN_Rx_ID, Enum_Motor_DM_Control_Method __Motor_DM_Control_Method, int32_t __Encoder_Offset, float __Current_Max)
{
    if (hfdcan->Instance == FDCAN1)
    {
        FDCAN_Manage_Object = &FDCAN1_Manage_Object;
...
void Class_Motor_DM_1_To_4::Data_Process()
{
    ...
    Struct_Motor_DM_CAN_Rx_Data_1_To_4 *tmp_buffer = (Struct_Motor_DM_CAN_Rx_Data_1_To_4 *) FDCAN_Manage_Object->Rx_Buffer.Data;
